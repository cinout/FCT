...
from FCT.data.datasets.builtin_meta_mvtecvoc import MVTECVOC_BASE_CATEGORIES
...
def main(split_path, split, keepclasses):
    ...
    classnames = MVTECVOC_BASE_CATEGORIES
    ...
    for i, fileid in enumerate(fileids):
        ...
        frame_crop_base_path = join(
            support_path, fileid
        )  # e.g., 'datasets/mvtecvoc/mvtecvocsplit/mvtecvoc_trainval_base/30302'
