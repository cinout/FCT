...
from .builtin_meta_mvtecvoc import _get_builtin_metadata_mvtecvoc
from .meta_pascal_voc import register_meta_pascal_voc
from .meta_mvtecvoc import register_meta_mvtecvoc
...
_PREDEFINED_SPLITS_COCO["coco"] = {
    "coco_2014_train_nonvoc": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_non_voc_instances_train2014.json",
    ),  # by default no_smaller_32
    "coco_2014_train_nonvoc_with_small": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_non_voc_instances_train2014_with_small.json",
    ),  # includeing all boxes
    "coco_2014_train_voc_10_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_10_shot_instances_train2014.json",
    ),
    "coco_2014_train_voc_1_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_1_shot_instances_train2014.json",
    ),
    "coco_2014_train_voc_2_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_2_shot_instances_train2014.json",
    ),
    "coco_2014_train_voc_3_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_3_shot_instances_train2014.json",
    ),
    "coco_2014_train_voc_5_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_5_shot_instances_train2014.json",
    ),
    "coco_2014_train_voc_30_shot": (
        "coco/trainval2014",
        "coco/new_annotations/final_split_voc_30_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_10_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_10_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_1_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_1_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_2_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_2_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_3_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_3_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_5_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_5_shot_instances_train2014.json",
    ),
    "coco_2014_train_full_30_shot": (
        "coco/trainval2014",
        "coco/new_annotations/full_class_30_shot_instances_train2014.json",
    ),
}
...
def register_all_coco(root):
    ...
    for shot in [1, 2, 3, 5, 10, 30]:
        for seed in range(1, 10):
            ...
            _PREDEFINED_SPLITS_COCO["coco"][name] = (
                "coco/trainval2014",
                "coco/new_annotations/seed{}/{}_shot_instances_train2014.json".format(
                    seed, shot
                ),
            )
            ...
            _PREDEFINED_SPLITS_COCO["coco"][name] = (
                "coco/trainval2014",
                "coco/new_annotations/seed{}/full_class_{}_shot_instances_train2014.json".format(
                    seed, shot
                ),
            )
...
_root = os.getenv("DETECTRON2_DATASETS", "datasets/mvtecvoc")
register_all_mvtecvoc(_root)
